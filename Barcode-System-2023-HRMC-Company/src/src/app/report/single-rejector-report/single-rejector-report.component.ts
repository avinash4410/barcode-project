...
@Component({
  selector: 'app-single-rejector-report',
  templateUrl: './single-rejector-report.component.html',
  styleUrls: ['./single-rejector-report.component.scss']
})
export class SingleRejectorReportComponent {
  data: any;
  id: any
